...
const SiteHero = ({ title, desc }: SiteHeroProps) => {
    return (
        <div className='from-primary to-slate-800 bg-gradient-to-tr w-full'>
            <div className='container flex flex-col text-white w-full h-full items-start justify-center aspect-square gap-4 md:gap-10 md:flex-row md:justify-start md:items-center md:aspect-video lg:aspect-[32/9]'>
